...
const {bet, apiData} = require("./container/bet.js");
const { bigSmall, account, route,  deposit, withdrow, activity } = require("./container/page.js");
const { loginPage, user, login, signUp, signupPage, logout } = require("./container/user.js");
...
router.post("/api/data", wrapAsync(apiData));
